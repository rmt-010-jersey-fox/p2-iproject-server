        ...
        Wishlist.findAll({
            ...
            .then(data => {
                if (data.length > 0) {
                    ...
                    return Wishlist.create(datas)
                }
            })
            .then(data => {
                let mailOptions = {
                    from: '"Franchise Kuy <info@franchisekuy.com>',
                    to: "fauzan@mail.com",
                    subject: "Wishlist Information",
                    text: "Your wishlist!",
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td align="center" valign="top" class="header-logo" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:10px 50px 30px;">
                                        <!-- // Logo block // -->
                                        <a href="//mailtrap.io" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#4DC3C9;text-decoration:none;"><img src="https://i.imgur.com/kdFuj1f.png" alt="Franchisekuy" width="146" height="30" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; vertical-align: middle; width: auto"></a>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="left" valign="top" class="header" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#3F3D55 url('https://link-to-another-hosted-image.png') repeat-y top;background-size:560px 150px;border-radius:50px 50px 0 0;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:28px 130px;" bgcolor="#3F3D55">
                                        <!-- // Header block // -->
                                          ...
                                          <tbody>
                                            <tr>
                                              <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">Your product has been successfully added to wishlist!</h1>
                                                <div>
                                                  <p class="header-text mobile-centered-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#fff;font-size:11px;line-height:14px;margin:0;padding-bottom:0;">
                                                    <a href="//mailtrap.io" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;text-decoration:none;"><strong>Franchise Kuy</strong></a>
                                                    <span style="padding: 0 11px 0 10px">|</span>The only way around is through
                                                    </p>
                                                  </div>
                                                </td>
                                              </tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td align="center" valign="top" class="section-heading" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:15px;">
                                                  ...
                                                  <img src="https://i.imgur.com/kdFuj1f.png" alt="verification changes" class="is-fittogrid" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; width: auto">
                                                </td>
                                              </tr>
                                              <tr>
                                                <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                                  <h1 style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;">
                                                    <span class="highlighted-text" style="color: #000">FK Support Team:</span>
                                                  </h1>
                                                </td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                                  <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;">One step closer to build your dinasty, be the king and conquered the house of stark mainland! </p>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                      ...
                                      <td align="left" valign="top" class="header" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#3F3D55 url('https://link-to-another-hosted-image.png') repeat-y top;background-size:560px 150px;border-radius:50px 50px 0 0;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:28px 130px;" bgcolor="#3F3D55">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                          <tbody>
                                            <tr>
                                              <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                                <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">Your product has been removed from wishlist</h1>
                                                <div>
                                                  <p class="header-text mobile-centered-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#fff;font-size:11px;line-height:14px;margin:0;padding-bottom:0;">
                                                    <a href="//mailtrap.io" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;text-decoration:none;"><strong>Franchise Kuy</strong></a>
                                                    <span style="padding: 0 11px 0 10px">|</span>The only way around is through
                                        ...
                                        <td align="left" valign="top" class="section is-top-merged" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#fff;border-radius:0 0 5px 5px;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:20px 50px 40px;" bgcolor="#ffffff">
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                                  <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;">It's okay to not to be okay, you have another way to reach your top, remember.. the sky is the limit!</p>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
